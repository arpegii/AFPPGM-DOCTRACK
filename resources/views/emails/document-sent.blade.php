...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .cta-button { display: inline-block; padding: 14px 32px; background: linear-gradient(135deg, #0B1F3A 0%, #1a3a5c 100%); color: #ffffff !important; text-decoration: none; border-radius: 8px; font-weight: 600; font-size: 15px; box-shadow: 0 4px 12px rgba(11, 31, 58, 0.3); }
