...
@if(auth()->user()->isAdmin())
    <div class="max-w-7xl mx-auto px-6 pb-2">
        <form method="GET" action="{{ route('received.index') }}" class="bg-white border border-gray-200 rounded-xl p-4">
            <div class="flex flex-col md:flex-row md:items-center gap-3">
                ...
                <div class="flex gap-2 md:justify-end md:ml-auto">
                    ...
                    <a href="{{ route('received.index', ['unit_id' => '']) }}" class="px-4 py-2 bg-gray-100 text-gray-700 text-sm font-semibold rounded-lg hover:bg-gray-200 transition">
                        Reset
                    </a>
                </div>
            </div>
                            ...
                            <td class="px-6 py-4 text-center">
                                <div class="flex items-center justify-center gap-2" x-data>
                                    ...
                                    <button
                                        ...
                                        type="button"
                                        class="px-3 py-1.5 rounded-md bg-blue-100 text-blue-700 hover:bg-blue-200 transition text-xs font-semibold">
                                        Forward
                                    </button>
